...
test.describe('OB-03. Locators', { tag: ['@onboarding'] }, () => {
  test('OB-03-01. should built-in locators be visible', async () => {
    ...
    //
    // Try to find the locators for the following elements throughout the opentable.com website
  ...
  test('OB-03-02. should custom locators be visible', async () => {
    ...
    //
    // Try to find the locators by CSS or XPath throughout the opentable.com website
  ...
  test('OB-03-03. should filtered locators be visible', async () => {
    ...
    // TODO:
    // Try to find the locators by locator.filter throughout the opentable.com website
